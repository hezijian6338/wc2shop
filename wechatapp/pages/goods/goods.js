    ...
    getCommentList: function (more) {
        ...
        app.request({
            ...
            success: function (res) {
                ...
                p++;
                page.setData({
                  comment_count: res.data.total,
                    comment_list: more ? page.data.comment_list.concat(res.data.list) : res.data.rows,
                });
